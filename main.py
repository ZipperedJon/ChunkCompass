...
def _diag(out_path: str | None) -> None:
    ...
    from chunkcompass import __version__, biomes, engine

    lines = [f"Chunk Compass {__version__}"]
    ...
    if engine.available():
        provider = biomes.get_provider("12345", "1.21.4", "overworld")
...
if __name__ == "__main__":
    if "--diag" in sys.argv:
        ...
        from chunkcompass.app import run
        run()
